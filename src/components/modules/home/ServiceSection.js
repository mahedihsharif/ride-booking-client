...
export default function ServicesSection() {
    ...
    let subText = "Experience convenience, safety, and affordability with every ride.";
    ...
    return (_jsx("section", { className: "py-20 bg-background", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 text-center", children: [_jsx("h2", { className: "text-3xl md:text-5xl font-bold mb-4 text-foreground", children: heading }), _jsx("p", { className: "text-lg md:text-xl mb-12 text-muted-foreground", children: subText }), _jsx("div", { className: "grid md:grid-cols-3 gap-8", children: servicesToRender.map((service, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 40 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6, delay: index * 0.2 }, children: _jsx(Card, { className: "rounded-2xl shadow-lg bg-card border-border", children: _jsxs(CardContent, { className: "flex flex-col items-center text-center gap-4", children: [_jsx("div", { className: "p-4 bg-[#50fa7b]/20 dark:bg-[#50fa7b]/10 rounded-full", children: _jsx(Check, { className: "w-6 h-6 text-[#50fa7b]" }) }), _jsx(CardTitle, { className: "text-xl font-semibold text-foreground", children: service.title }), _jsx("p", { className: "text-muted-foreground", children: service.description })] }) }) }, index))) })] }) }));
}
