...
const suggestions = [
    {
        ...
        icon: _jsx(Car, { className: "w-12 h-12 text-primary" }),
    },
    {
        title: "Reserve",
        ...
        icon: _jsx(Calendar, { className: "w-12 h-12 text-primary" }),
    },
    {
        title: "Intercity",
        ...
        icon: _jsx(Clock, { className: "w-12 h-12 text-primary" }),
    },
    {
        title: "Courier",
        ...
        icon: _jsx(Package, { className: "w-12 h-12 text-primary" }),
    },
    {
        title: "Rentals",
    ...
    },
    {
        ...
        icon: _jsx(Bike, { className: "w-12 h-12 text-primary" }),
    },
];
const SuggestionsSection = () => {
    return (_jsxs("section", { className: "py-12 px-4 md:px-12 bg-background text-foreground", children: [_jsx("h2", { className: "text-3xl font-bold mb-8 text-center", children: "Suggestions" }), _jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: suggestions.map((item, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.4, delay: index * 0.1 }, children: _jsx(Card, { className: "rounded-2xl shadow-md border dark:border-gray-700 hover:shadow-lg transition", children: _jsxs(CardContent, { className: "p-6 flex flex-col items-start gap-4", children: [item.icon, _jsx("h3", { className: "text-xl font-semibold", children: item.title }), _jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: item.description }), _jsxs(Dialog, { children: [_jsx(DialogTrigger, { asChild: true, children: _jsx(Button, { variant: "secondary", className: "mt-auto rounded-full cursor-pointer bg-primary/20 hover:bg-primary/30 text-primary font-bold", children: "Details" }) }), _jsxs(DialogContent, { className: "sm:max-w-[500px] bg-card border-border", children: [_jsxs(DialogHeader, { children: [_jsxs(DialogTitle, { className: "flex items-center gap-3 text-2xl text-foreground", children: [item.icon, " ", item.title] }), _jsx(DialogDescription, { className: "text-base mt-4 text-muted-foreground leading-relaxed", children: item.fullDetails })] }), _jsx("div", { className: "flex justify-end mt-4", children: _jsxs(Button, { onClick: () => (window.location.href = "/register"), className: "rounded-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold px-8", children: ["Try ", item.title, " Now"] }) })] })] })] }) }) }, index))) })] }));
};
